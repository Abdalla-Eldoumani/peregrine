...
// cudaEvent-timed warm GEMM, the firm GPU-08 measurement primitive 04-06's bench
// reads instead of a wall-clock approximation around an async launch (which is
// meaningless: the launch returns before the device finishes). a and b are
